...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <!-- updateSach-->
    <form id="frmSach" name="frmSach" action="deleteSach" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-10 col-sm-10 col-xs-12" style="outline: 1px solid orange;">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <input class="form-control" id="txtMaSach" name="txtMaSach" placeholder="Nhập mã sách" type="text"  value="<?php if(isset($value['masach'])) echo $value['masach'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Tên Sách:</label>
                <input class="form-control" id="txtTenSach" name="txtTenSach" placeholder="Nhập tên sách" type="text" value="<?php if(isset($value['tensach'])) echo $value['tensach'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Tác giả:</label>
                <input class="form-control" id="txtTacGia" name="txtTacGia" placeholder="Nhập tác giả" type="text" value="<?php if(isset($value['tacgia'])) echo $value['tacgia'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Thể loại:</label>
                <input class="form-control" id="txtTheLoai" name="txtTheLoai" placeholder="Nhập thể loại" type="text" value="<?php if(isset($value['theloai'])) echo $value['theloai'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Nhà cung cấp:</label>
                <input class="form-control" id="txtNCC" name="txtNCC" placeholder="Nhập nhà cung cấp" type="text" value="<?php if(isset($value['mancc'])) echo $value['mancc'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Nhà xuất bản:</label>
                <input class="form-control" id="txtNXB" name="txtNXB" placeholder="Nhập nhà xuất bản" type="text" value="<?php if(isset($value['nhaxuatban'])) echo $value['nhaxuatban'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Số lượng:</label>
                <input class="form-control" id="txtSoLuong" name="txtSoLuong" placeholder="Số lượng" type="text" value="<?php if(isset($value['soluong'])) echo $value['soluong'];?>" readOnly>
              </div>
              <div class="col-md-6 col-sm-12 col-xs-12">
                <label for="sel1">Ngày nhập cuối:</label>
                <input class="form-control" id="txtNgayNhap" name="txtNgayNhap" placeholder="Số lượng" type="text" value="<?php if(isset($value['ngaynhap'])) echo $value['ngaynhap'];?>" readOnly>
              </div>
              <div class="col-md-4 col-sm-16 col-xs-12">
                <label for="sel1">Giá nhập:</label>
                <input class="form-control" id="txtGiaNhap" name="txtGiaNhap" placeholder="Giá nhập" type="text" value="<?php if(isset($value['gianhap'])) echo $value['gianhap'];?>" readOnly>
              </div>
              <div class="col-md-4 col-sm-16 col-xs-12">
                <label for="sel1">Giá bán:</label>
                <input class="form-control" id="txtGiaBan" name="txtGiaBan" placeholder="Giá bán" type="text" value="<?php if(isset($value['giaban'])) echo $value['giaban'];?>" readOnly>
              </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12" id="hinhanh">
              <br>
              <img class="img-thumbnail" id="hienthiImg" src="../../../public/dist/img/<?php if(isset($value['hinhanh'])) echo $value['hinhanh'];?>" alt="Hinh-anh-sach">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-md-6 text-left">
        <br><label><button id="btnLapPhieuNhap" type="submit" class="btn btn-primary">Xóa</button></label> 
      </div>
    </div>
