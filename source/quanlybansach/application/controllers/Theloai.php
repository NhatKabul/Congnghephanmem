...
class Theloai extends CI_Controller {
    ...
    public function index()
    {
        ...
        $config["total_rows"] = $this->Theloai_model->record_count();
        $config["per_page"] = 10;
        ...
        $data['data_info'] = $this->Theloai_model->get_DanhsachPhanTrang($config['per_page'], $page);
  ...
  /*  public function update()
    ...
    public function chitiet()
    {
        ...
        $data['data_info']=$this->Theloai_model->getTheLoaiSachByID($idSach);
