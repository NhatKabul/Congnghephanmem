...
var rowCount = 0;
    ...
    $(document).ready(function(){
        $("#btnthemchitiet").click(function(){
            ...
            rowCount ++;
            $("tbody").prepend("<tr id='rowCount"+rowCount+"'><td>"+MaSach+"</td><td>"+soluong+"</td><td>"+DonGia+"</td><td class='thanhtien'>"+DonGia*soluong+"</td><td><a href='javascript:void(0);' onclick='removeRow("+rowCount+");'>Delete</a></td></tr>");
